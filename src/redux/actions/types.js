...
// create text node
export const CREATE_TEXT_NODE = 'CREATE_TEXT_NODE';
export const CREATE_TEXT_NODE_SUCCESS = 'CREATE_TEXT_NODE_SUCCESS';
export const CREATE_TEXT_NODE_ERROR = 'CREATE_TEXT_NODE_ERROR';
// fetch text node
export const FETCH_TEXT_NODE = 'FETCH_TEXT_NODE';
export const FETCH_TEXT_NODE_SUCCESS = 'FETCH_TEXT_NODE_SUCCESS';
export const FETCH_TEXT_NODE_ERROR = 'FETCH_TEXT_NODE_ERROR';
// delete text node
export const DELETE_TEXT_NODE = 'DELETE_TEXT_NODE';
export const DELETE_TEXT_NODE_SUCCESS = 'DELETE_TEXT_NODE_SUCCESS';
export const DELETE_TEXT_NODE_ERROR = 'DELETE_TEXT_NODE_ERROR';
// edit text node
...
// create image node
export const CREATE_IMAGE_NODE = 'CREATE_IMAGE_NODE';
export const CREATE_IMAGE_NODE_SUCCESS = ' CREATE_IMAGE_NODE_SUCCESS';
export const CREATE_IMAGE_NODE_ERROR = 'CREATE_IMAGE_NODE_ERROR';
// fetch image node
export const FETCH_IMAGE_NODE = 'FETCH_IMAGE_NODE';
export const FETCH_IMAGE_NODE_SUCCESS = 'FETCH_IMAGE_NODE_SUCCESS';
export const FETCH_IMAGE_NODE_ERROR = 'FETCH_IMAGE_NODE_ERROR';
// fetch user node
